...
typedef struct {
    ...
    __IO u32 SYSCFGR;                                                           ///< System Configuration Register                  offset: 0x40
		__IO u32 RESERVED7;                                                         ///< Reserved                                       offset: 0x44
    __IO u32 RESERVED8;                                                         ///< Reserved                                       offset: 0x48
    __IO u32 RESERVED9;                                                         ///< Reserved                                       offset: 0x4C
    __IO u32 PLLCFGR;                                                         ///< Reserved                                       offset: 0x50
} RCC_TypeDef;
